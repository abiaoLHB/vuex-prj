...
<section data-v-695ac596="" class="content"><div data-v-247f02de="" data-v-695ac596="" class="studentlimits_page"><section data-v-247f02de="" class="content-header" style="padding: 15px 0px;"><h1 data-v-247f02de="">
            我的订单
            <small data-v-247f02de=""></small></h1> </section> <div data-v-247f02de=""><div data-v-247f02de="" class="nav-tabs-custom"><ul data-v-247f02de="" class="nav nav-tabs font-16"><li data-v-247f02de="" class="active"></li>  <li data-v-247f02de=""></li></ul> <div data-v-247f02de="" class="tab-content" style="padding-top: 10px;"><div data-v-247f02de="" id="tab1" class="active tab-pane"><div data-v-247f02de="" class="box-body no-padding">  <div data-v-247f02de="" class="course_tabs"><div data-v-247f02de="" class="course_tab"><div data-v-247f02de="" class="search_box"><div data-v-247f02de="" class="" style="padding-left: 0px;width: 59%;"><label data-v-247f02de="" class="col-sm-3" style="padding: 5px 0px 0px;">订单名称：</label> <div data-v-247f02de="" class="col-sm-9" style="padding: 0px;"><div data-v-247f02de="" class="modal-input ivu-input-wrapper ivu-input-type"><!----> <!----> <i class="ivu-icon ivu-icon-load-c ivu-load-loop ivu-input-icon ivu-input-icon-validate"></i> <input type="text" placeholder="订单名称名称" class="ivu-input"> <!----></div></div></div> <div data-v-247f02de="" class="col-md-3 col-sm-6" style="padding-left: 0px;"> <div data-v-247f02de="" class="col-sm-9" style="padding: 0px;"><div data-v-247f02de="" class="modal-input ivu-input-wrapper ivu-input-type"><!----> <!----> <i class="ivu-icon ivu-icon-load-c ivu-load-loop ivu-input-icon ivu-input-icon-validate"></i>  <!----></div></div></div> <div data-v-247f02de="" class="col-md-3 col-sm-6" style="
    padding-bottom: 30px;
"><button data-v-247f02de="" type="button" class="btn btn-primary btn-margin-r12">查询</button><button data-v-247f02de="" type="button" class="btn btn-default">清空</button></div> <div data-v-247f02de="" style="clear: both;"></div></div> <div data-v-247f02de="" style="clear: both; margin-bottom: 24px;"><a data-v-247f02de="" href="#/shoppingCart/buyCourse" class="" style="cursor: pointer;"><a data-v-247f02de="" class="btn btn-primary">订单管理</a></a></div> <div data-v-247f02de="" class="box-body table-responsive no-padding col-md-12" style="min-height: 422px;"><table data-v-247f02de="" class="table table-hover"><thead data-v-247f02de=""><tr data-v-247f02de=""><th data-v-247f02de="" title="课程编号" class="col-md-1 col-xs-1">订单编号</th> <th data-v-247f02de="" title="订单名称" class="col-md-2 col-xs-2">课程标题</th> <th data-v-247f02de="" title="导师" class="col-md-1 col-xs-1">客户名称</th> <th data-v-247f02de="" title="订单状态" class="col-md-1 col-xs-1">课程状态</th> <th data-v-247f02de="" title="浏览数" class="col-md-1 col-xs-1">浏览数</th> <th data-v-247f02de="" title="评论数" class="col-md-1 col-xs-1">评论数</th> <th data-v-247f02de="" title="操作" class="col-md-3 col-xs-3">操作</th></tr></thead> <tbody data-v-247f02de=""><tr data-v-247f02de="" id="117"><td data-v-247f02de="" title="117">117</td> <td data-v-247f02de="" title="商业模式C.V.S系统解读">商品1</td> <td data-v-247f02de="" title="陈明亮">罗红彪</td> <td data-v-247f02de="" title="上线">未支付</td> <td data-v-247f02de="" title="105215">105215</td> <td data-v-247f02de="" title="692">692</td> <td data-v-247f02de="" class="operate-btnbox"><i data-v-247f02de=""></i> <a data-v-247f02de="" href="#/" class="active">
                                   订单详情
                                </a><i data-v-247f02de=""></i> <a data-v-247f02de="" href="javascript:;"> 修改权限 </a></td></tr><tr data-v-247f02de="" id="117"><td data-v-247f02de="" title="117">117</td> <td data-v-247f02de="" title="商业模式C.V.S系统解读">商品2</td> <td data-v-247f02de="" title="陈明亮">罗红彪</td> <td data-v-247f02de="" title="上线">未支付</td> <td data-v-247f02de="" title="105215">105215</td> <td data-v-247f02de="" title="692">692</td> <td data-v-247f02de="" class="operate-btnbox"><i data-v-247f02de=""></i> <a data-v-247f02de="" href="#/" class="active">
                                   订单详情
                                </a><i data-v-247f02de=""></i> <a data-v-247f02de="" href="javascript:;"> 修改权限 </a></td></tr><tr data-v-247f02de="" id="121"><td data-v-247f02de="" title="121">121</td> <td data-v-247f02de="" title="商品3">商品3</td> <td data-v-247f02de="" title="陈明亮">罗红彪</td> <td data-v-247f02de="" title="上线">未支付</td> <td data-v-247f02de="" title="1629">1629</td> <td data-v-247f02de="" title="37">37</td> <td data-v-247f02de="" class="operate-btnbox"><i data-v-247f02de=""></i> <a data-v-247f02de="" href="#/" class="active">
                                   订单详情
                                </a><i data-v-247f02de=""></i> <a data-v-247f02de="" href="javascript:;"> 修改权限 </a></td></tr><tr data-v-247f02de="" id="122"><td data-v-247f02de="" title="122">122</td> <td data-v-247f02de="" title="商业模式C.V.S系统解读（三）">商品4</td> <td data-v-247f02de="" title="陈明亮">罗红彪</td> <td data-v-247f02de="" title="上线">未支付</td> <td data-v-247f02de="" title="1708">1708</td> <td data-v-247f02de="" title="35">35</td> <td data-v-247f02de="" class="operate-btnbox"><i data-v-247f02de=""></i> <a data-v-247f02de="" href="#/" class="active">
                                   订单详情
                                </a><i data-v-247f02de=""></i> <a data-v-247f02de="" href="javascript:;"> 修改权限 </a></td></tr><tr data-v-247f02de="" id="122"><td data-v-247f02de="" title="122">122</td> <td data-v-247f02de="" title="商业模式C.V.S系统解读（三）">商品5</td> <td data-v-247f02de="" title="陈明亮">罗红彪</td> <td data-v-247f02de="" title="上线">未支付</td> <td data-v-247f02de="" title="1708">1708</td> <td data-v-247f02de="" title="35">35</td> <td data-v-247f02de="" class="operate-btnbox"><i data-v-247f02de=""></i> <a data-v-247f02de="" href="#/" class="active">
                                   订单详情
                                </a><i data-v-247f02de=""></i> <a data-v-247f02de="" href="javascript:;"> 修改权限 </a></td></tr></tbody></table> <!----></div></div></div></div></div></div> <div data-v-247f02de="" class="box-footer"><div data-v-247f02de="" id="pager" class="pager"><span data-v-247f02de="" class="btn btn-default disabled">
                      首页
                  </span> <span data-v-247f02de="" class="btn btn-default disabled">
                      上一页
                  </span> <span data-v-247f02de="" class="btn btn-default active active">
                    1
                  </span> <!----> <!----> <!----> <!----> <span data-v-247f02de="" class="btn btn-default disabled">
                      下一页
                  </span> <span data-v-247f02de="" class="btn btn-default disabled">
                      尾页
                  </span><!----> <!----> <!----> <!----> <!----> <!----> <!----> <!----> <!----></div></div> <!----> <!----></div></div> <div data-v-72800dc8="" data-v-247f02de="" class="overlay" style="display: none;"><div data-v-72800dc8="" class="demo-spin-col ivu-spin ivu-spin-fix ivu-spin-show-text"><div class="ivu-spin-main"><span class="ivu-spin-dot"></span> <div class="ivu-spin-text"><i data-v-72800dc8="" class="demo-spin-icon-load ivu-icon ivu-icon-load-c"></i> <div data-v-72800dc8="" class="loading-text">Loading</div></div></div></div></div></div></section>
